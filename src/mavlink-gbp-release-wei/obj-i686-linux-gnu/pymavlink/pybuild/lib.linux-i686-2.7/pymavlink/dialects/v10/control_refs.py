...
Generated from: control_refs.xml,common.xml
...
MAV_SENSOR_ROTATION_MAX = 38 # Roll: 315, Pitch: 315, Yaw: 315
enums['MAV_SENSOR_ORIENTATION'][38] = EnumEntry('MAV_SENSOR_ROTATION_MAX', '''Roll: 315, Pitch: 315, Yaw: 315''')
...
MAVLINK_MSG_ID_CONTROL_REFS = 150
...
class MAVLink_control_refs_message(MAVLink_message):
        '''
        This message encodes all of the control references from the
        USV.
        '''
        id = MAVLINK_MSG_ID_CONTROL_REFS
        name = 'CONTROL_REFS'
        fieldnames = ['theta', 'phi', 'psi', 'thrust']
        ordered_fieldnames = [ 'theta', 'phi', 'psi', 'thrust' ]
        format = '<ffff'
        ...
        def __init__(self, theta, phi, psi, thrust):
                MAVLink_message.__init__(self, MAVLink_control_refs_message.id, MAVLink_control_refs_message.name)
                self._fieldnames = MAVLink_control_refs_message.fieldnames
                self.theta = theta
                self.phi = phi
                self.psi = psi
                self.thrust = thrust
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 87, struct.pack('<ffff', self.theta, self.phi, self.psi, self.thrust))
...
mavlink_map = {
        MAVLINK_MSG_ID_CONTROL_REFS : MAVLink_control_refs_message,
...
class MAVLink(object):
        ...
        def decode(self, msgbuf):
                ...
                return m
        def control_refs_encode(self, theta, phi, psi, thrust):
                '''
                This message encodes all of the control references from the USV.
                ...
                '''
                return MAVLink_control_refs_message(theta, phi, psi, thrust)

        def control_refs_send(self, theta, phi, psi, thrust):
                '''
                This message encodes all of the control references from the USV.
                ...
                '''
                return self.send(self.control_refs_encode(theta, phi, psi, thrust))
